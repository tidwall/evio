...
type Server struct {
	// The addr parameter is the listening addresses that align
...
func Serve(addr string, events Events) error {
	var stdlib bool
	var ln listener
	var stdlibt bool
